...
const Pagination = ({pageNo,setpageNo,totalPages}) => {
    return (
        <div className="pagination z-[99] gap-10 justify-between fixed bottom-5 flex items-center w-[94.8%] bg-white p-2 rounded">
